            ...
            while ((line = br.readLine()) != null) {
                if (line.startsWith("Data: ")) {
                    ...
                    switch (taskID) {
                        ...
                        case 2 -> {
                            cuttedLine = cutterInput(line);
                            ObjectsDB.createMedia(cuttedLine[0], cuttedLine[1], cuttedLine[2], cuttedLine[3], cuttedLine[4], cuttedLine[5]); //mediaCategory, mediaID, mediaName, date, Regal, publisher
                        }
                        case 3 -> {
                            cuttedLine = cutterInput(line);
